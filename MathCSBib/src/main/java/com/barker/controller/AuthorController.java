...
public class AuthorController {
	...
	@RequestMapping(value="/admin/newAuthor", method=RequestMethod.POST)
	...
	@RequestMapping(value="/admin/{authorId}/update", method=RequestMethod.GET)
	...
	@RequestMapping(value="/admin/{authorId}/delete", method=RequestMethod.POST)
